...
using NiveraAPI.Networking.Entities.Messages;
...
/// </summary>
public class EntityManager : NetworkService
{
    ...
    public override void Update(float localDeltaTime, float networkDeltaTime)
    {
        base.Update(localDeltaTime, networkDeltaTime);
